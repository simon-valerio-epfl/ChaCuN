...
public final class Board {
    ...
    public Set<Pos> insertionPositions() {
        ...
        for (int idx: orderedTileIndexes) {
            ...
            // loop over N, E, S, W
            //TODO: WILL CRUSH IF THE TILE IS IN THE EDGE,
            //TODO: WE NEED TO CHECK IF THE TILE IS IN THE EDGE
        ...
        //TODO: VALERIO'S ADD, I don't know if it's correct to make it unmodifiable
        return Collections.unmodifiableSet(insertionPositions);
    }
    //TODO: VALERIO'S ADD; TO TEST
    ...
    public Set<Area<Zone.Forest>> forestsClosedByLastTile() {
        //TODO, I changed this in the next method, to review by Simon
        //which is better
    ...
    public Set<Area<Zone.River>> riversClosedByLastTile() {
        //TODO, I changed this, to review by Simon
        if (!hasAtLeastOneTile()) return Set.of();
    ...
    public Board withMoreCancelledAnimals(Set<Animal> newlyCancelledAnimals) {
        ...
        //TODO, I changed this, to review by Simon
        return new Board(placedTiles.clone(),
                orderedTileIndexes.clone(),
                zonePartitions,
                Collections.unmodifiableSet(newCancelledAnimals));
    }
