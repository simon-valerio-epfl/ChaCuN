...
/**
 * This class represents the main class of the ChaCuN game, a javafx application
...
public final class Main extends Application {
    ...
    /**
     * Updates the state of the game and the list of actions
     *
     * @param stateAction the new state of the game and the action to do
     * @param gameStateO  the observable updating value of the game state
     * @param actionsO    the observable updating value of the list of actions since the beginning of the game
     */
