...
javac -d out/production/classes @src_files.txt --enable-preview --release 21 --module-path ${JAVAFX_SDK_PATH}/lib --add-modules javafx.controls,javafx.fxml
# build test class
javac -d out/test/classes -classpath out/production/classes:junit-platform-console-standalone-1.10.2.jar @test_files.txt --enable-preview --release 21 --module-path ${JAVAFX_SDK_PATH}/lib --add-modules javafx.controls,javafx.fxml
